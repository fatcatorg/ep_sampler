...
# --------------------------------------------------------------------------
# 8 manifest guides - like the Ting FX types, each biases the build.
# --------------------------------------------------------------------------

GUIDES = [
    {"key": "full", "name": "FULL KIT",
     "essence": "balanced - a bit of everything",
     "weights": {c: 1.0 for c in CATEGORIES}, "shuffle": False},
    {"key": "drums", "name": "DRUMS",
     "essence": "drum-focused - kicks, snares, hats, percussion",
     "weights": {"kick": 3, "snare": 3, "clap": 2, "hat": 3, "perc": 2,
                 "tom": 1}, "shuffle": False},
    {"key": "bass", "name": "BASS",
     "essence": "bass-forward with light drums and chords",
     "weights": {"kick": 1, "snare": 1, "hat": 1, "bass": 4, "chord": 2,
                 "melody": 2}, "shuffle": False},
    {"key": "melodic", "name": "MELODIC",
     "essence": "chords, melodies and bass",
     "weights": {"bass": 2, "chord": 3, "melody": 4, "fx": 1, "vocal": 1},
     "shuffle": False},
    {"key": "dub", "name": "DUB",
     "essence": "dub / sound-system - heavy bass, fx and percussion",
     "weights": {"kick": 3, "hat": 1, "perc": 2, "tom": 1, "bass": 3,
                 "fx": 2, "vocal": 1}, "shuffle": False},
    {"key": "techno", "name": "TECHNO",
     "essence": "techno - kicks, hats, claps, percussion",
     "weights": {"kick": 4, "hat": 3, "clap": 2, "perc": 2, "bass": 1},
     "shuffle": False},
    {"key": "vocal", "name": "VOCAL",
     "essence": "vocals and fx forward with a little rhythm",
     "weights": {"vocal": 4, "fx": 2, "kick": 1, "snare": 1, "hat": 1},
     "shuffle": False},
